...
export default function TambahBuku() {
  ...
  const [gagal, setGagal] = React.useState(true);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(e);
      setMessage("ada yang masih kosong mas")
      alert("aduh gagal maseh");
      setGagal(e?.response?.data?.errors);
    }
    ...
    <React.Fragment>
      <div>
        <form action="" onSubmit={handleSubmit}>
          <h1 className="text-red-600 italic font-bold">{message}</h1>
          <Input
